      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-[10%] sm:top-[15%] inset-x-4 sm:inset-x-auto sm:left-1/2 sm:-translate-x-1/2 sm:w-full max-w-lg bg-card rounded-2xl border border-border shadow-2xl z-[101] overflow-hidden"
          >
