      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-3 w-80 max-w-[calc(100vw-2rem)] bg-card rounded-2xl border border-border shadow-xl overflow-hidden z-50 sm:right-0 -right-12"
          >
